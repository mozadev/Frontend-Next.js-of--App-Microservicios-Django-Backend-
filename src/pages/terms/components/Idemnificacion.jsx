        ...
        <div className="relative px-4 sm:px-6 lg:px-8 font-worksans-light">
            <div className="mt-6 prose prose-blue prose-lg text-gray-500 mx-auto">
                ...
                <p className="mt-4 text-xl text-gray-500 leading-8">
                    Usted se compromete a indemnizar y eximir de responsabilidad a webmoza (y a sus
                    ...
                    webmoza se reserva el derecho, a su cargo, de asumir la defensa y el control exclusivos
                    ...
                    cualquier asunto indemnizable sin nuestro consentimiento previo por escrito. webmoza se
