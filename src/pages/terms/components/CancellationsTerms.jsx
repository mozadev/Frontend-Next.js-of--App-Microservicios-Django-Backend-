        ...
        <div className="relative px-4 sm:px-6 lg:px-8 font-worksans-light">
            ...
            <div className="text-lg max-w-prose mx-auto">
                ...
                <p className="mt-4 text-xl text-gray-500 leading-8">
                    ...
                    mail@webmoza.com. Después de la cancelación, su Plan Premium permanecerá activo hasta
            ...
            <div className="text-lg max-w-prose mx-auto">
                ...
                <p className="mt-4 text-xl text-gray-500 leading-8">
                    ...
                    webmoza no tendrá ninguna responsabilidad ante usted por la terminación de sus derechos
