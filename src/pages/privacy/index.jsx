...
const SeoList = {
    title: 'Política de Privacidad - webmoza, Empresa de Desarrollo de Software',
    description:
        'La Política de Privacidad de webmoza explica cómo recopilamos, utilizamos y protegemos la información personal de nuestros clientes y usuarios. Conozca nuestros compromisos y responsabilidades en relación con la privacidad y protección de datos.',
    href: '/privacy-policy',
    url: 'https://webmoza.com/privacy-policy',
    keywords:
        'webmoza, política de privacidad, protección de datos, empresa de desarrollo de software',
    robots: 'all',
    author: 'webmoza',
    publisher: 'webmoza',
    image:
