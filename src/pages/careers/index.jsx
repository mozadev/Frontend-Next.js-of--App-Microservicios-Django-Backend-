...
const SeoList = {
    title: 'Join the Team - webmoza NFT Marketplace',
    description:
        'Find exciting career opportunities at webmoza, the ultimate NFT marketplace for online courses, physical products, and more. We are looking for talented individuals to help us shape the future of e-commerce with the power of blockchain technology.',
    href: '/',
    url: 'https://webmoza.com',
    keywords: 'webmoza, webmoza affiliates, affiliate marketing NFT, nft affiliate marketing',
    robots: 'all',
    author: 'webmoza',
    publisher: 'webmoza',
    image:
