...
const SeoList = {
    title:
        'Podcasts de webmoza - Descubre nuestras conversaciones sobre marketing y desarrollo de software',
    description:
        'Escucha nuestros podcasts en webmoza, donde discutimos temas de actualidad en marketing y desarrollo de software. Únete a nosotros para aprender, inspirarte y mantenerte al día en la industria.',
    href: '/podcasts',
    url: 'https://webmoza.com/podcasts',
    keywords:
